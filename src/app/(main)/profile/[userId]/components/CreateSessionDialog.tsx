...
export default function CreateSessionDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md md:max-w-xl max-h-[90vh] overflow-auto scrollbar-thin scrollbar-thumb-darkblue scrollbar-track-darkblue hover:scrollbar-thumb-darkblue">
        <DialogHeader>
