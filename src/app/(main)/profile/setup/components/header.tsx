...
export default function Header() {
  ...
  return (
    <CardHeader className="bg-linear-to-r from-white/30 to-white/10 px-8 pt-8 pb-6">
      <div className="mx-auto max-w-3xl">
        <div className="flex items-start gap-4">
          <div className="p-3 rounded-full bg-linear-to-br from-amber-50 to-pink-50 shadow-sm">
        ...
        <div className="mt-6 flex items-center gap-3">
          <div className="text-xs font-medium px-3 py-1 rounded-full bg-linear-to-r from-blue-100 to-purple-100 text-darkblue shadow-sm">
            New account
          </div>
          ...
          <div className="ml-auto w-40 h-2 bg-slate-100 rounded-full overflow-hidden">
            <div
              className="h-full bg-linear-to-r from-darkblue to-blue-500"
              style={{ width: "30%" }}
            />
          </div>
        </div>
